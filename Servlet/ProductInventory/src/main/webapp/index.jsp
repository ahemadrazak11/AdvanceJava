	...
	<div class="cards">
		<article>
			<div  class="card_items" id="customer_card_image">
				...
				<div><a href="Customer.jsp"><div class="card_buttons">Access Customer Portal <i class="fa-solid fa-arrow-right"></i></div></a></div>
			</div>
		</article>
	</div>
	<!-- second card -->
	<div class="cards">
		<article>
			<div class="card_items" id="employee_card_image">
				...
				<div><a href=""><div class="card_buttons">Access Employee Portal <i class="fa-solid fa-arrow-right"></i></div></a></div>
			</div>
		</article>
	</div>
	<!-- third card -->
	<div class="cards">
		<article>
			<div class="card_items" id="admin_card_image">
				...
				<div><a href=""><div class="card_buttons">Access Admin Portal <i class="fa-solid fa-arrow-right"></i></div></a></div>
			</div>
		</article>
	</div>
